                ...
                <el-template>
                    	<section>
                            ...
                            <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
                                ...
                                <el-table-column prop="nickName" label="支付金额" width="120" >
                                </el-table-column> 
                                <el-table-column prop="mobile" label="退款金额" width="180" >
                                </el-table-column>
                                <el-table-column prop="birth" label="退款原因" width="120" >
                                </el-table-column>
                                <el-table-column prop="createTime" label="买家" min-width="180" >
                                </el-table-column>
                                    <el-table-column prop="createTime" label="退货物流" min-width="180" >
                                </el-table-column>
                                    <el-table-column prop="createTime" label="状态" min-width="180" >
                                </el-table-column>
