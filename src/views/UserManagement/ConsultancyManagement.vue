<template>
	<section>
		...
		<el-col :span="24" class="toolbar">
			...
			<el-pagination small layout="prev, pager, next" @current-change="handleCurrentChange" :page-size="10" :total="total" style="float:right;">
			</el-pagination>
		</el-col>
	</section>
</template>
...
export default {
	...
	methods: {
		...
		addUser: function() {
			this.$router.push({ path: '/ConsultancyDetails', query: { pageType: "add" } })
		},
		editUser: function(index, row) {
			...
			this.$router.push({ path: '/ConsultancyDetails', query: { pageType: "edit", token: row.id } });
			// }); 
		},
		//显示新增界面
		handleAdd: function() {
